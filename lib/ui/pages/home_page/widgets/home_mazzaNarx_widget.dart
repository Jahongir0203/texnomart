...
class HomeMazzaNarx extends StatelessWidget {
  const HomeMazzaNarx(
      {Key? key, required this.homeController, required this.bagsController})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        shrinkWrap: true,
        itemCount: homeController.mainPageModel!.collectionsModel!.data!
            ...
            child: InkWell(
              onTap: () {
                Get.toNamed(AppRoutes.detailPage,
                    arguments: homeController.mainPageModel?.collectionsModel
                            ?.data?.data?[0].products?[index].id ??
                        0);
              },
              child: SizedBox(
                width: 130,
                  ...
                  child: Column(
                    ...
                    children: [
                      Stack(
                        children: [
                          SizedBox(
                            height: 150,
                            child: Image.network(
                              homeController.mainPageModel!.collectionsModel!
                                      .data!.data![0].products![index].image ??
                                  '',
                            ),
                          ),
                          SizedBox(
                      ...
                      Padding(
                        ...
                        child: Text(
                          homeController.mainPageModel!.collectionsModel!.data!
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            Text(
                              homeController.mainPageModel!.collectionsModel!
                                      .data!.data![0].products![index].salePrice
                                      .toString() ??
                                  '',
                              style: const TextStyle(
                                  color: Colors.black,
