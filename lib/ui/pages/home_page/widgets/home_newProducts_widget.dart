    ...
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemCount: homeController
                .mainPageModel!.newProductsModel!.data!.data!.length ??
            0,
            ...
            child: InkWell(
              onTap: () {
                Get.toNamed(AppRoutes.detailPage,
                    arguments: homeController.mainPageModel?.newProductsModel
                        ?.data?.data?[index].id);
              },
              child: SizedBox(
                width: 130,
                        ...
                        children: [
                          Container(
                              ...
                              child: Obx(() => IconButton(
                                    onPressed: () {
                                      if (bagsController.listFavorites!.value
                                    ...
                                    icon: bagsController.listFavorites!.value
                                            .contains(homeController
                                                    .mainPageModel
                                                    ?.newProductsModel
                                                    ?.data
                      ...
                      Container(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              Text(
                                homeController.mainPageModel!.newProductsModel!
